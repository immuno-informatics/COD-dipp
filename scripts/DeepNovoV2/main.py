...
import torch
from data_reader import (DeepNovoDenovoDataset, DeepNovoTrainDataset,
                         collate_func)
...
from train_func import build_model, perplexity, train, validation
...
def main():
    if deepnovo_config.args.train:
        ...
        denovo_worker = IonCNNDenovo(
            deepnovo_config.MZ_MAX,
